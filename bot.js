...
const devs = ['454834294771417089'];
const db = require('quick.db');
const premium = ['454834294771417089']
...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.youtube.com/channel/UCslo3BB-0Bkjt1P8WDwKYeg?view_as=subscriber`);
    }, ms);
...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By LEoN
    let pages = [`**
        ***__General orders__***
**
...
client.login('OTI0MDA0Mjk5Mjk2NjA0MjEw.YcYQEA.nepJnGERZisobpBUpNGvJ44mp_8');
client.on('message', message => {
...
client.on('message', async(message) => {
    ...
    client.on('guildMemberRemove', member => {
        ...
        .setTitle(`لقد غادر السيرفر ✋`)
        .setDescription(`مع السلامه ✋ `)
